...
| 榜单、拆书 | 已实现：扫榜含在线抓取、快照趋势与 AI 解读；拆书含逐章 AI 拆解与全书报告。旧版的自动补抓开关、评论抓取与封面生图未移植 |
| 取名、封面生图 | 未实现 |
