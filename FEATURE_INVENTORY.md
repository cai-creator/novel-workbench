...
已实现：独立 Vue 项目、作品书架与章节管理、正文编辑、本机自动保存、故事概念与设定库、四类 AI 生成、预览后采纳、四步建书工作流、基础章节版本历史、新版 JSON 作品导入导出。未实现：旧版数据迁移、桌面容器、逐章自动生文、榜单、拆书、每日统计、图片生成和完整版本对比。Agnes 已按官方接口文档加入预设与连接测试，真实账号调用仍待验证。
